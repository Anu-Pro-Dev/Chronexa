    ...
    return(
        <div className='shadow-card rounded-[10px] bg-white p-2'>
            <div className='flex flex-row justify-between p-4'>
                <h5 className='text-lg text-text-primary font-bold'>Leaves</h5>
            ...
            <div className='flex p-3'>
                <div>
                    ...
                    <p className='text-2xl text-primary font-bold pt-2'>212</p>
                </div>
                ...
                <div>
                    ...
                    <p className='text-2xl text-[#6741CA] font-bold pt-2'>09</p>
                </div>
                <div className='w-[1px] h-[60px] mx-4 bg-text-secondary flex self-center opacity-15'></div>
                <div>
                    <div className='flex gap-10'>
                        <p className='text-text-secondary font-semibold text-sm w-[60px]'>Leaves Taken</p>
                        <div className='icon-group bg-background w-[35px] h-[35px] flex justify-center items-center rounded-[10px]  text-[#FFBF00] shadow-[0_0_20px_15px_rgba(255,191,0,0.15)]'>
                            {LeaveTakenIcon()}
                        </div>
                    </div>
                    <p className='text-2xl text-[#FFBF00] font-bold pt-2'>06</p>
                </div>
            </div>
            ...
            <div className='flex p-3'>
                <div>
                    ...
                    <p className='text-2xl text-[#DA153E] font-bold pt-2'>03</p>
                </div>
                <div className='w-[1px] h-[60px] mx-4 bg-text-secondary flex self-center opacity-15'></div>
                <div>
                    <div className='flex gap-10'>
                    ...
                    <p className='text-2xl text-[#1DAA61] font-bold pt-2'>02</p>
                </div>
                <div className='w-[1px] h-[60px] mx-4 bg-text-secondary flex self-center opacity-15'></div>
                <div>
                    <div className='flex gap-10'>
                    ...
                    <p className='text-2xl text-[#FF6347] font-bold pt-2'>01</p>
                </div>
            </div>
        </div>
    )
