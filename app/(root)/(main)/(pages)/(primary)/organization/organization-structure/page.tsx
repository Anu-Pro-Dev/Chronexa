...
//     // Assign org_type_level to organizations
//     organizations.forEach((org) => {
//       const orgNode = nodeMap[`org_${org.organization_id}`];
...
//     // Use children of organization_id = 0 as root nodes
...
//                 ? "bg-gradient-to-tl from-blue-600 to-blue-800 text-white"
//                 : "bg-white text-gray-800 border border-gray-200"
//             } ${level === 0 ? "w-[50%] mx-auto mt-5" : "w-[50%] ml-[4rem]"}`}
//             onClick={() => hasChildren && toggleNode(node.id)}
//           >
//             <div className="flex items-center gap-2">
...
//             <div
//               ref={childrenContainerRef}
//               className="flex flex-col gap-3 mt-3 ml-[4rem] w-full"
//             >
//               {node.children.map((child) => (
