import { EmailDataType, SmsDataType } from "./types/types";
...
export const email_data: EmailDataType[] = [
  {
    ...
    email_body:
      "Dear Employee102,Employee58 has applied in TIMECHECK attendance system for manual movement for 18-07-2024 please Click here to take necessary action for the same.Regards,HR DepartmentTime And Attendance System",
    status: "Sent",
    cc_email: "",
    bcc_email: "",
  ...
  },
  {
    ...
    subject: "Permission Notification",
    email_body:
      "Dear Employee79, Employee56 has applied in TIMECHECK attendance system for  Permission for 21-09-2024, please <a href='https://ta.dgs.gov.ae/Approval/Pending-Approval' target='_blank'>Click here</a> to take necessary action for the same.  Regards, HR Department Time And Attendance System Note: This is an automated email notification generated from the system. Please do not respond to this email address. If further assistance is required, please contact HR Department .",
    status: "Unsent",
    cc_email: "",
    bcc_email: "",
    complete_violation: "<i class='icon-remove'></i>",
