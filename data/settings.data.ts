...
export const settings_data: AllSettingsDataType[] = [
  ...
  },
  {
    ...
    deletable: "🗴",
    description:
      "If SHOW_ABSENT is false then system will not show ABSENT for OPEN SHIFT SCHEDULE.",
    updated_by: "ADMIN",
  ...
  },
  {
    ...
    deletable: "🗴",
    description:
      "No.of minutes between consecutive punches for the same employee to count as duplicate",
    updated_by: "ADMIN",
    updatedAt: "21-11-2013",
  },
  {
