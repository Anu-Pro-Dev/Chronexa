    ...
    return (
        <div className="bg-foreground rounded-[20px] mx-6 p-6 pb-0">
            <header className='mb-6'>
                <h1 className='text-primary font-bold text-xl'>Leave {currentTab}</h1>
                <p className='text-text-secondary font-regular text-sm'>Leave <span className='lowercase'>{currentTab}</span>  can be viewed in this tab</p>
            </header>
