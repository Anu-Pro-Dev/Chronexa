...
function VerificationModelPopup({openVerificationTab, setOpenVerificationTab} : {openVerificationTab: boolean, setOpenVerificationTab: any}) {
                ...
                {(onClose) => (
                    <>
                        <ModalHeader className="flex flex-col gap-1">
                            <h1 className="text-xl font-bold text-text-primary capitalize">VERIFICATION TAB</h1>
...
export default VerificationModelPopup
