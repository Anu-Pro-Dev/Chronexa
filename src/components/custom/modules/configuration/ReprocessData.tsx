...
import { ActionIcon, CalendarIcon, ExclamationIcon } from "@/src/icons/icons";
import { Checkbox } from "@/src/components/ui/checkbox";
import ReprocessDataTakeAction from "@/src/components/custom/modules/configuration/ReprocessDataTakeAction";
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="bg-accent p-6 rounded-2xl relative">
        <div className="pb-3">
          <h1 className="font-medium text-xl text-primary">Reprocess data</h1>
        </div>
