...
import { forgotPasswordRequest } from "@/src/lib/apiHandler";
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="">
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 flex gap-2 justify-center">
            <Button size={"lg"} variant={"outline"} className="w-auto" onClick={() => router.push('/')}>{translations.buttons.cancel}</Button>
