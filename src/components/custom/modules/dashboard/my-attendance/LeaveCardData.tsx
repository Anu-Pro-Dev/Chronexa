...
export default function LeaveCardData({ page }: LeaveCardDataProps) {
    ...
    const leavesData = [
        { 
            ...
            value: displayValues.TotalWorkingDays,
            color: "text-primary", 
        ...
        { 
            ...
            value: displayValues.TotalLeaves,
            color: "text-[#6741CA]", 
        ...
        { 
            ...
            value: displayValues.LeaveTaken,
            color: "text-[#FFBF00]", 
            icon: LeaveTakenIcon(), 
        ...
        { 
            ...
            value: displayValues.ApprovedLeaves,
            color: "text-[#1DAA61]", 
            icon: ApprovedIcon(), 
        ...
        { 
            ...
            value: displayValues.BalanceLeaves,
            color: "text-[#FF6347]", 
            icon: PendingIcon(), 
    ...
    const permissionsData = [
        { 
            label: t?.total_perms, 
            value: displayValues.TotalPermission,
            color: "text-[#6741CA]", 
            icon: TotalLeavesIcon(), 
            shadow: "shadow-[0_0_20px_15px_rgba(103,65,202,0.05)]",
            isHours: true
        ...
        { 
            ...
            value: displayValues.PendingPermission,
            color: "text-[#FF6347]", 
            icon: PendingIcon(), 
            shadow: "shadow-[0_0_20px_15px_rgba(255,99,71,0.1)]",
            isHours: true
