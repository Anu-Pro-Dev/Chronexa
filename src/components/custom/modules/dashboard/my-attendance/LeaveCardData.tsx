  ...
  const leavesCards: KpiCardData[] = [
    {
      ...
      color: "#0078D4",
      icon: React.cloneElement(WorkingDaysIcon() as React.ReactElement, { color: "#0078D4" }),
    },
    {
      ...
      color: "#F59E0B",
      icon: React.cloneElement(LeaveTakenIcon() as React.ReactElement, { color: "#F59E0B" }),
    },
    {
  ...
  const permsCards: KpiCardData[] = [
    {
      ...
      progress: 100,
      color: "#8B5CF6",
      icon: React.cloneElement(TotalLeavesIcon() as React.ReactElement, { color: "#8B5CF6" }),
    },
    {
