...
export default function PowerSearch({ props }: { props: any }) {
  ...
  return (
    <div className="bg-accent border border-border-accent min-w-auto md:min-w-[200px] md:max-w-[250px] px-4 py-3 flex items-center shadow-searchbar rounded-full">
