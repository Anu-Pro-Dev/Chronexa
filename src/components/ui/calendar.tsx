      ...
      <div className="grid grid-cols-4 gap-2">
        {years.map((year) => (
          <Button
            ...
            className={cn(
              "h-8 text-sm hover:bg-primary hover:text-primary-foreground transition-colors",
              year === internalMonth.getFullYear() && "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground"
            )}
          >
            {year}
          </Button>
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          "size-6 p-0 font-normal text-sm transition-none hover:bg-transparent hover:text-inherit aria-selected:opacity-100 aria-selected:bg-primary aria-selected:text-primary-foreground"
        ),
        selected:
