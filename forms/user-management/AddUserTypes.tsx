...
import { addUserTypeRequest } from "@/lib/apiHandler"; // Import API request function
...
export default function AddUserTypes({
  on_open_change,
  selectedRowData,
  onSave,
}: {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
      try {
        ...
        if (selectedRowData) {
          ...
          const response = await addUserTypeRequest(values.typeName, values.descriptionEng, values.descriptionArb);
